(()=>{var b=(r,e)=>()=>(e||r((e={exports:{}}).exports,e),e.exports);var M=b((ar,F)=>{var G=`
  /* \u2500\u2500 Base \u2500\u2500 */
  .sf-gr-wrap {
...
`;F.exports={styles:G}});var A=b((tr,q)=>{var{styles:V}=M();function c(r){return String(r).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}var U=`<svg width="80" height="26" viewBox="0 0 272 92" xmlns="http://www.w3.org/2000/svg">
  ...
  <path d="M35.29 41.41V32H67c.31 1.64.47 3.58.47 5.68 0 7.06-1.93 15.79-8.15 22.01-6.05 6.3-13.78 9.66-24.02 9.66C16.32 69.35.36 53.89.36 34.91.36 15.93 16.32.47 35.3.47c10.5 0 17.98 4.12 23.6 9.49l-6.64 6.64c-4.03-3.78-9.49-6.72-16.97-6.72-13.86 0-24.7 11.17-24.7 25.03 0 13.86 10.84 25.03 24.7 25.03 8.99 0 14.11-3.61 17.39-6.89 2.66-2.66 4.41-6.46 5.1-11.65l-22.49.01z" fill="#4285F4"/>
</svg>`;function C(r){var e=Math.min(5,Math.max(0,Math.round(Number(r)||0)));return"\u2605".repeat(e)+"\u2606".repeat(5-e)}function D(r){return r&&r.split(" ").filter(Boolean).map(function(e){return e[0]}).join("").slice(0,2).toUpperCase()||"?"}function K(r){let o=r.text.length>120,a=o?r.text.slice(0,120)+"...":r.text,s=r.profile_photo_url?`<img class="sf-gr-avatar" src="${c(r.profile_photo_url)}" alt="${c(r.author_name)}" onerror="this.style.display='none';this.nextElementSibling.style.display='flex'">`:"",d=`<div class="sf-gr-avatar-initials" ${r.profile_photo_url?'style="display:none"':""}>${D(c(r.author_name))}</div>`;return`<div class="sf-gr-card">
    ...
    <div class="sf-gr-text">
      <span class="sf-gr-review-body">${c(a)}</span>
      ${o?'<span class="sf-gr-readmore"> Read more</span>':""}
    </div>
  </div>`}function P(r){let e=r.dataset.widgetKey,o=r.dataset.theme||"";if(!e){r.textContent="Missing data-widget-key";return}if(!document.getElementById("sf-gr-styles")){let s=document.createElement("style");s.id="sf-gr-styles",s.textContent=V,document.head.appendChild(s)}let a=o?" sf-gr-"+o:"";r.innerHTML='<div class="sf-gr-wrap'+a+'"><div class="sf-gr-loading">Loading reviews...</div></div>',fetch("https://social-feeds-app.netlify.app/.netlify/functions/google-reviews?widget_key="+encodeURIComponent(e)).then(function(s){return s.json()}).then(function(s){Y(r,s)}).catch(function(){var s=r.querySelector(".sf-gr-wrap");s&&(s.innerHTML="Could not load reviews.")})}function Y(r,e){for(var o=e.rating,a=e.user_ratings_total,s=e.url,d=typeof s=="string"&&s.startsWith("https://")?s:"#",i=e.reviews,n=r.querySelector(".sf-gr-wrap"),h=typeof window<"u"&&window.innerWidth<=768?1:4,p=0,u=Math.ceil(i.length/h),y="",v=0;v<u;v++)y+='<button class="sf-gr-dot'+(v===0?" active":"")+'" data-idx="'+v+'"></button>';n.innerHTML='<div class="sf-gr-header"><div class="sf-gr-header-left"><div class="sf-gr-logo">'+U+' Reviews</div><div class="sf-gr-rating-row"><span class="sf-gr-score">'+o.toFixed(1)+'</span><span class="sf-gr-stars">'+C(o)+'</span><span class="sf-gr-count">('+a+')</span></div></div><a class="sf-gr-btn" href="'+d+'" target="_blank" rel="noopener">Review us on Google</a></div><div class="sf-gr-carousel"><button class="sf-gr-arrow sf-gr-prev">&#10094;</button><div class="sf-gr-track">'+i.map(K).join("")+'</div><button class="sf-gr-arrow sf-gr-next">&#10095;</button></div><div class="sf-gr-dots">'+y+'</div><a class="sf-gr-viewall" href="'+d+'" target="_blank" rel="noopener">View All Reviews on Google</a>';var k=n.querySelector(".sf-gr-carousel"),z=n.querySelector(".sf-gr-track"),_=n.querySelectorAll(".sf-gr-dot"),x=0;function E(){var t=k.getBoundingClientRect(),g=window.getComputedStyle(k),f=t.width-parseFloat(g.paddingLeft)-parseFloat(g.paddingRight);if(f<=0)return 0;var l=Math.floor(f/h)-12;return n.querySelectorAll(".sf-gr-card").forEach(function(m){m.style.flex="0 0 "+l+"px",m.style.maxWidth=l+"px"}),z.style.width=f*u+"px",f}function L(){z.style.transform="translateX(-"+p*x+"px)"}var O=n.querySelectorAll(".sf-gr-readmore");O.forEach(function(t){t.addEventListener("click",function(){var g=t.previousElementSibling,f=t.closest(".sf-gr-card"),l=n.querySelectorAll(".sf-gr-card"),m=Array.prototype.indexOf.call(l,f);g.textContent=i[m].text,t.remove()})});function w(t){p=(t%u+u)%u;var g=E();g>0&&(x=g),L(),_.forEach(function(f,l){f.classList.toggle("active",l===p)})}n.querySelector(".sf-gr-prev").addEventListener("click",function(){w(p-1)}),n.querySelector(".sf-gr-next").addEventListener("click",function(){w(p+1)}),_.forEach(function(t){t.addEventListener("click",function(){w(parseInt(t.dataset.idx,10))})});function S(){var t=E();t>0&&(x=t,L())}if(typeof ResizeObserver<"u"){var W=new ResizeObserver(function(){S()});W.observe(r)}else(function t(){x>0||(S(),x||requestAnimationFrame(t))})()}q.exports={mountGoogleReviews:P}});var T=b((nr,R)=>{var N=`
  .sf-ig-wrap {
    font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;
    max-width: 100%;
    box-sizing: border-box;
...
`;R.exports={styles:N}});var I=b((ir,B)=>{var{styles:X}=T();function J(r){var e=r.dataset.widgetKey;if(!e){r.textContent="data-widget-key is required";return}if(!document.getElementById("sf-ig-styles")){var o=document.createElement("style");o.id="sf-ig-styles",o.textContent=X,document.head.appendChild(o)}r.innerHTML='<div class="sf-ig-wrap"><div class="sf-ig-loading">Loading feed...</div></div>',fetch("https://social-feeds-app.netlify.app/.netlify/functions/instagram-feed?widget_key="+encodeURIComponent(e)).then(function(a){return a.json()}).then(function(a){Q(r,a)}).catch(function(){var a=r.querySelector(".sf-ig-wrap");a&&(a.innerHTML="Could not load Instagram feed.")})}function Q(r,e){var o=e.profile,a=e.posts,s=r.querySelector(".sf-ig-wrap"),d=a.map(function(i){var n=i.media_type==="VIDEO"?i.thumbnail_url||i.media_url||"":i.media_url||"",h=i.media_type==="VIDEO";return'<a class="sf-ig-post" href="'+i.permalink+'" target="_blank" rel="noopener"><img src="'+n+'" alt="Instagram post" loading="lazy">'+(h?'<span class="sf-ig-video-icon">&#9654;</span>':"")+"</a>"}).join("");s.innerHTML='<div class="sf-ig-header"><div class="sf-ig-avatar-ring"><img src="'+o.profile_picture_url+'" alt="'+o.username+`" onerror="this.onerror=null;this.src=''"></div><div class="sf-ig-meta"><div class="sf-ig-handle">@`+o.username+'</div><div class="sf-ig-counts"><span class="sf-ig-count-item"><strong>'+o.media_count+'</strong> Posts</span><span class="sf-ig-count-item"><strong>'+o.followers_count+'</strong> Followers</span><span class="sf-ig-count-item"><strong>'+o.follows_count+'</strong> Following</span></div></div><a class="sf-ig-follow-btn" href="https://instagram.com/'+o.username+'" target="_blank" rel="noopener">Follow</a></div><div class="sf-ig-grid">'+d+"</div>"}B.exports={mountInstagramFeed:J}});var $=b((fr,H)=>{var{mountGoogleReviews:Z}=A(),{mountInstagramFeed:rr}=I(),er={"google-reviews":Z,"instagram-feed":rr};function or(){document.querySelectorAll("[data-widget]").forEach(e=>{let o=e.dataset.widget,a=er[o];if(a)try{a(e)}catch(s){console.error(`[SocialFeeds] Widget "${o}" failed to mount:`,s)}else console.warn(`[SocialFeeds] Unknown widget: "${o}"`)})}H.exports={mountWidgets:or}});var{mountWidgets:j}=$();document.readyState==="loading"?document.addEventListener("DOMContentLoaded",j):j();})();
